...
/**
 * Determine whether value passes omitted requirement. True if undefined or optional.
 * @param                      value    - Value of field.
 * @param  {Boolean|Function}  omitted  - Model required value. Boolean or Error object for custom error message.
 * @return {Boolean}
 * @private
*/
function validateOmitted(value, omitted) {
  if (typeof omitted === 'function') {
    return omitted.call(null, value);
  }
  else {
    return typeof value === 'undefined' || !omitted;
  }
}
...
exports.omitted = validateOmitted;
